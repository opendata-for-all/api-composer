 ...
 * @generated
 */
public class XOpenAPISwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case XOpenAPIPackage.SCHEMA_EXTENSION: {
				SchemaExtension schemaExtension = (SchemaExtension)theEObject;
				T result = caseSchemaExtension(schemaExtension);
				if (result == null) result = caseNamedElement(schemaExtension);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case XOpenAPIPackage.ENTITY: {
				...
				if (result == null) result = caseSchemaExtension(entity);
			...
			case XOpenAPIPackage.PROPERTY: {
				...
				if (result == null) result = caseSchemaExtension(property);
			...
			case XOpenAPIPackage.NAVIGATION_PROPERTY: {
				...
				if (result == null) result = caseSchemaExtension(navigationProperty);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Schema Extension</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Schema Extension</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseSchemaExtension(SchemaExtension object) {
		return null;
	}
