 ...
 * </p>
 * <ul>
 *   <li>{@link edu.uoc.som.xopenapi.ExternalDocsContext#getExternalDocs <em>External Docs</em>}</li>
 * </ul>
 *
 * @see edu.uoc.som.xopenapi.XOpenAPIPackage#getExternalDocsContext()
 * @model abstract="true"
 * @generated
 */
public interface ExternalDocsContext extends EObject {
	 ...
	 * @see edu.uoc.som.xopenapi.XOpenAPIPackage#getExternalDocsContext_ExternalDocs()
	...
	/**
	 * Sets the value of the '{@link edu.uoc.som.xopenapi.ExternalDocsContext#getExternalDocs <em>External Docs</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
