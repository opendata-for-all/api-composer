 ...
 * </p>
 * <ul>
 *   <li>{@link edu.uoc.som.xopenapi.Path#getRelativePath <em>Relative Path</em>}</li>
 *   <li>{@link edu.uoc.som.xopenapi.Path#getGet <em>Get</em>}</li>
 *   <li>{@link edu.uoc.som.xopenapi.Path#getPut <em>Put</em>}</li>
 *   <li>{@link edu.uoc.som.xopenapi.Path#getPost <em>Post</em>}</li>
 *   <li>{@link edu.uoc.som.xopenapi.Path#getDelete <em>Delete</em>}</li>
 *   <li>{@link edu.uoc.som.xopenapi.Path#getOptions <em>Options</em>}</li>
 *   <li>{@link edu.uoc.som.xopenapi.Path#getHead <em>Head</em>}</li>
 *   <li>{@link edu.uoc.som.xopenapi.Path#getPatch <em>Patch</em>}</li>
 *   <li>{@link edu.uoc.som.xopenapi.Path#getApi <em>Api</em>}</li>
 * </ul>
 *
 * @see edu.uoc.som.xopenapi.XOpenAPIPackage#getPath()
 * @model
 * @generated
 */
public interface Path extends ParamterDeclaringContext, ParameterContext {
	 ...
	 * @see edu.uoc.som.xopenapi.XOpenAPIPackage#getPath_RelativePath()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link edu.uoc.som.xopenapi.Path#getRelativePath <em>Relative Path</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see edu.uoc.som.xopenapi.XOpenAPIPackage#getPath_Get()
	...
	/**
	 * Sets the value of the '{@link edu.uoc.som.xopenapi.Path#getGet <em>Get</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see edu.uoc.som.xopenapi.XOpenAPIPackage#getPath_Put()
	 * @model containment="true"
	 * @generated
	 */
	Operation getPut();
	...
	/**
	 * Sets the value of the '{@link edu.uoc.som.xopenapi.Path#getPut <em>Put</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see edu.uoc.som.xopenapi.XOpenAPIPackage#getPath_Post()
	 * @model containment="true"
	 * @generated
	 */
	Operation getPost();
	...
	/**
	 * Sets the value of the '{@link edu.uoc.som.xopenapi.Path#getPost <em>Post</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see edu.uoc.som.xopenapi.XOpenAPIPackage#getPath_Delete()
	 * @model containment="true"
	 * @generated
	 */
	Operation getDelete();
	...
	/**
	 * Sets the value of the '{@link edu.uoc.som.xopenapi.Path#getDelete <em>Delete</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see edu.uoc.som.xopenapi.XOpenAPIPackage#getPath_Options()
	 * @model containment="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link edu.uoc.som.xopenapi.Path#getOptions <em>Options</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see edu.uoc.som.xopenapi.XOpenAPIPackage#getPath_Head()
	 * @model containment="true"
	 * @generated
	 */
	Operation getHead();
	...
	/**
	 * Sets the value of the '{@link edu.uoc.som.xopenapi.Path#getHead <em>Head</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see edu.uoc.som.xopenapi.XOpenAPIPackage#getPath_Patch()
	 * @model containment="true"
	 * @generated
	 */
	Operation getPatch();
	...
	/**
	 * Sets the value of the '{@link edu.uoc.som.xopenapi.Path#getPatch <em>Patch</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link edu.uoc.som.xopenapi.API#getPaths <em>Paths</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see #setApi(API)
	 * @see edu.uoc.som.xopenapi.XOpenAPIPackage#getPath_Api()
	...
	/**
	 * Sets the value of the '{@link edu.uoc.som.xopenapi.Path#getApi <em>Api</em>}' container reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
