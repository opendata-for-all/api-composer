 ...
 * </p>
 * <ul>
 *   <li>{@link edu.uoc.som.xopenapi.impl.RootImpl#getApi <em>Api</em>}</li>
 *   <li>{@link edu.uoc.som.xopenapi.impl.RootImpl#getParamters <em>Paramters</em>}</li>
 *   <li>{@link edu.uoc.som.xopenapi.impl.RootImpl#getSchemas <em>Schemas</em>}</li>
 *   <li>{@link edu.uoc.som.xopenapi.impl.RootImpl#getResponses <em>Responses</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RootImpl extends MinimalEObjectImpl.Container implements Root {
	...
	protected EClass eStaticClass() {
		return XOpenAPIPackage.Literals.ROOT;
	}
	...
	public NotificationChain basicSetApi(API newApi, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, XOpenAPIPackage.ROOT__API, oldApi, newApi);
	...
	public void setApi(API newApi) {
		if (newApi != api) {
			...
			if (api != null)
				msgs = ((InternalEObject)api).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - XOpenAPIPackage.ROOT__API, null, msgs);
			if (newApi != null)
				msgs = ((InternalEObject)newApi).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - XOpenAPIPackage.ROOT__API, null, msgs);
			msgs = basicSetApi(newApi, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XOpenAPIPackage.ROOT__API, newApi, newApi));
	}
	...
	public EList<Parameter> getParamters() {
		if (paramters == null) {
			paramters = new EObjectContainmentEList<Parameter>(Parameter.class, this, XOpenAPIPackage.ROOT__PARAMTERS);
		}
		return paramters;
	}
	...
	public EList<Schema> getSchemas() {
		if (schemas == null) {
			schemas = new EObjectContainmentEList<Schema>(Schema.class, this, XOpenAPIPackage.ROOT__SCHEMAS);
		}
		return schemas;
	}
	...
	public EList<Response> getResponses() {
		if (responses == null) {
			responses = new EObjectContainmentEList<Response>(Response.class, this, XOpenAPIPackage.ROOT__RESPONSES);
		}
		return responses;
	}
