 ...
 * </p>
 * <ul>
 *   <li>{@link edu.uoc.som.xopenapi.impl.ArrayContextImpl#getCollectionFormat <em>Collection Format</em>}</li>
 *   <li>{@link edu.uoc.som.xopenapi.impl.ArrayContextImpl#getItems <em>Items</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class ArrayContextImpl extends MinimalEObjectImpl.Container implements ArrayContext {
	...
	protected EClass eStaticClass() {
		return XOpenAPIPackage.Literals.ARRAY_CONTEXT;
	}
	...
	public void setCollectionFormat(CollectionFormat newCollectionFormat) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XOpenAPIPackage.ARRAY_CONTEXT__COLLECTION_FORMAT, oldCollectionFormat, collectionFormat));
	}
	...
	public NotificationChain basicSetItems(ItemsDefinition newItems, NotificationChain msgs) {
		...
		items = newItems;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, XOpenAPIPackage.ARRAY_CONTEXT__ITEMS, oldItems, newItems);
	...
	public void setItems(ItemsDefinition newItems) {
		if (newItems != items) {
			...
			if (items != null)
				msgs = ((InternalEObject)items).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - XOpenAPIPackage.ARRAY_CONTEXT__ITEMS, null, msgs);
			if (newItems != null)
				msgs = ((InternalEObject)newItems).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - XOpenAPIPackage.ARRAY_CONTEXT__ITEMS, null, msgs);
			msgs = basicSetItems(newItems, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XOpenAPIPackage.ARRAY_CONTEXT__ITEMS, newItems, newItems));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case XOpenAPIPackage.ARRAY_CONTEXT__ITEMS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case XOpenAPIPackage.ARRAY_CONTEXT__COLLECTION_FORMAT:
