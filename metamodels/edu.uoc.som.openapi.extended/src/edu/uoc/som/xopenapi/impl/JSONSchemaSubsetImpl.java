 ...
 * </p>
 * <ul>
 *   <li>{@link edu.uoc.som.xopenapi.impl.JSONSchemaSubsetImpl#getType <em>Type</em>}</li>
 *   <li>{@link edu.uoc.som.xopenapi.impl.JSONSchemaSubsetImpl#getFormat <em>Format</em>}</li>
 *   <li>{@link edu.uoc.som.xopenapi.impl.JSONSchemaSubsetImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link edu.uoc.som.xopenapi.impl.JSONSchemaSubsetImpl#getMaximum <em>Maximum</em>}</li>
 *   <li>{@link edu.uoc.som.xopenapi.impl.JSONSchemaSubsetImpl#getExclusiveMaximum <em>Exclusive Maximum</em>}</li>
 *   <li>{@link edu.uoc.som.xopenapi.impl.JSONSchemaSubsetImpl#getMinimum <em>Minimum</em>}</li>
 *   <li>{@link edu.uoc.som.xopenapi.impl.JSONSchemaSubsetImpl#getExclusiveMinimum <em>Exclusive Minimum</em>}</li>
 *   <li>{@link edu.uoc.som.xopenapi.impl.JSONSchemaSubsetImpl#getMaxLength <em>Max Length</em>}</li>
 *   <li>{@link edu.uoc.som.xopenapi.impl.JSONSchemaSubsetImpl#getMinLength <em>Min Length</em>}</li>
 *   <li>{@link edu.uoc.som.xopenapi.impl.JSONSchemaSubsetImpl#getPattern <em>Pattern</em>}</li>
 *   <li>{@link edu.uoc.som.xopenapi.impl.JSONSchemaSubsetImpl#getMaxItems <em>Max Items</em>}</li>
 *   <li>{@link edu.uoc.som.xopenapi.impl.JSONSchemaSubsetImpl#getMinItems <em>Min Items</em>}</li>
 *   <li>{@link edu.uoc.som.xopenapi.impl.JSONSchemaSubsetImpl#getUniqueItems <em>Unique Items</em>}</li>
 *   <li>{@link edu.uoc.som.xopenapi.impl.JSONSchemaSubsetImpl#getEnum <em>Enum</em>}</li>
 *   <li>{@link edu.uoc.som.xopenapi.impl.JSONSchemaSubsetImpl#getDefault <em>Default</em>}</li>
 *   <li>{@link edu.uoc.som.xopenapi.impl.JSONSchemaSubsetImpl#getMultipleOf <em>Multiple Of</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class JSONSchemaSubsetImpl extends MinimalEObjectImpl.Container implements JSONSchemaSubset {
	...
	protected EClass eStaticClass() {
		return XOpenAPIPackage.Literals.JSON_SCHEMA_SUBSET;
	}
	...
	public void setType(JSONDataType newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XOpenAPIPackage.JSON_SCHEMA_SUBSET__TYPE, oldType, type));
	}
	...
	public void setFormat(String newFormat) {
		...
		format = newFormat;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XOpenAPIPackage.JSON_SCHEMA_SUBSET__FORMAT, oldFormat, format));
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XOpenAPIPackage.JSON_SCHEMA_SUBSET__DESCRIPTION, oldDescription, description));
	}
	...
	public void setMaximum(Double newMaximum) {
		...
		maximum = newMaximum;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XOpenAPIPackage.JSON_SCHEMA_SUBSET__MAXIMUM, oldMaximum, maximum));
	}
	...
	public void setExclusiveMaximum(Boolean newExclusiveMaximum) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XOpenAPIPackage.JSON_SCHEMA_SUBSET__EXCLUSIVE_MAXIMUM, oldExclusiveMaximum, exclusiveMaximum));
	}
	...
	public void setMinimum(Double newMinimum) {
		...
		minimum = newMinimum;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XOpenAPIPackage.JSON_SCHEMA_SUBSET__MINIMUM, oldMinimum, minimum));
	}
	...
	public void setExclusiveMinimum(Boolean newExclusiveMinimum) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XOpenAPIPackage.JSON_SCHEMA_SUBSET__EXCLUSIVE_MINIMUM, oldExclusiveMinimum, exclusiveMinimum));
	}
	...
	public void setMaxLength(Integer newMaxLength) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XOpenAPIPackage.JSON_SCHEMA_SUBSET__MAX_LENGTH, oldMaxLength, maxLength));
	}
	...
	public void setMinLength(Integer newMinLength) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XOpenAPIPackage.JSON_SCHEMA_SUBSET__MIN_LENGTH, oldMinLength, minLength));
	}
	...
	public void setPattern(String newPattern) {
		...
		pattern = newPattern;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XOpenAPIPackage.JSON_SCHEMA_SUBSET__PATTERN, oldPattern, pattern));
	}
	...
	public void setMaxItems(Integer newMaxItems) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XOpenAPIPackage.JSON_SCHEMA_SUBSET__MAX_ITEMS, oldMaxItems, maxItems));
	}
	...
	public void setMinItems(Integer newMinItems) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XOpenAPIPackage.JSON_SCHEMA_SUBSET__MIN_ITEMS, oldMinItems, minItems));
	}
	...
	public void setUniqueItems(Boolean newUniqueItems) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XOpenAPIPackage.JSON_SCHEMA_SUBSET__UNIQUE_ITEMS, oldUniqueItems, uniqueItems));
	}
	...
	public EList<String> getEnum() {
		if (enum_ == null) {
			enum_ = new EDataTypeUniqueEList<String>(String.class, this, XOpenAPIPackage.JSON_SCHEMA_SUBSET__ENUM);
		}
		return enum_;
	}
	...
	public void setDefault(String newDefault) {
		...
		default_ = newDefault;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XOpenAPIPackage.JSON_SCHEMA_SUBSET__DEFAULT, oldDefault, default_));
	}
	...
	public void setMultipleOf(double newMultipleOf) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XOpenAPIPackage.JSON_SCHEMA_SUBSET__MULTIPLE_OF, oldMultipleOf, multipleOf));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case XOpenAPIPackage.JSON_SCHEMA_SUBSET__TYPE:
				return getType();
			case XOpenAPIPackage.JSON_SCHEMA_SUBSET__FORMAT:
				return getFormat();
			case XOpenAPIPackage.JSON_SCHEMA_SUBSET__DESCRIPTION:
				return getDescription();
			case XOpenAPIPackage.JSON_SCHEMA_SUBSET__MAXIMUM:
				return getMaximum();
			case XOpenAPIPackage.JSON_SCHEMA_SUBSET__EXCLUSIVE_MAXIMUM:
				return getExclusiveMaximum();
			case XOpenAPIPackage.JSON_SCHEMA_SUBSET__MINIMUM:
				return getMinimum();
			case XOpenAPIPackage.JSON_SCHEMA_SUBSET__EXCLUSIVE_MINIMUM:
				return getExclusiveMinimum();
			case XOpenAPIPackage.JSON_SCHEMA_SUBSET__MAX_LENGTH:
				return getMaxLength();
			case XOpenAPIPackage.JSON_SCHEMA_SUBSET__MIN_LENGTH:
				return getMinLength();
			case XOpenAPIPackage.JSON_SCHEMA_SUBSET__PATTERN:
				return getPattern();
			case XOpenAPIPackage.JSON_SCHEMA_SUBSET__MAX_ITEMS:
				return getMaxItems();
			case XOpenAPIPackage.JSON_SCHEMA_SUBSET__MIN_ITEMS:
				return getMinItems();
			case XOpenAPIPackage.JSON_SCHEMA_SUBSET__UNIQUE_ITEMS:
				return getUniqueItems();
			case XOpenAPIPackage.JSON_SCHEMA_SUBSET__ENUM:
				return getEnum();
			case XOpenAPIPackage.JSON_SCHEMA_SUBSET__DEFAULT:
				return getDefault();
			case XOpenAPIPackage.JSON_SCHEMA_SUBSET__MULTIPLE_OF:
