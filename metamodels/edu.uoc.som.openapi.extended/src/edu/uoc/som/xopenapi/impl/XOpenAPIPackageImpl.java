...
import edu.uoc.som.xopenapi.License;
import edu.uoc.som.xopenapi.NamedElement;
import edu.uoc.som.xopenapi.NavigationProperty;
import edu.uoc.som.xopenapi.OAuth2FlowType;
...
import edu.uoc.som.xopenapi.Root;
...
import edu.uoc.som.xopenapi.SecuritySchemeType;
import edu.uoc.som.xopenapi.SecurityScope;
import edu.uoc.som.xopenapi.Tag;
import edu.uoc.som.xopenapi.TypedElement;
import edu.uoc.som.xopenapi.XMLElement;
import edu.uoc.som.xopenapi.XOpenAPIFactory;
import edu.uoc.som.xopenapi.XOpenAPIPackage;

import edu.uoc.som.xopenapi.util.XOpenAPIValidator;
 ...
 * @generated
 */
public class XOpenAPIPackageImpl extends EPackageImpl implements XOpenAPIPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @generated
	 */
	private EClass schemaExtensionEClass = null;
	 ...
	 * @see edu.uoc.som.xopenapi.XOpenAPIPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private XOpenAPIPackageImpl() {
		super(eNS_URI, XOpenAPIFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link XOpenAPIPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static XOpenAPIPackage init() {
		if (isInited) return (XOpenAPIPackage)EPackage.Registry.INSTANCE.getEPackage(XOpenAPIPackage.eNS_URI);

		// Obtain or create and register package
		XOpenAPIPackageImpl theXOpenAPIPackage = (XOpenAPIPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof XOpenAPIPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new XOpenAPIPackageImpl());

		isInited = true;

		// Create package meta-data objects
		theXOpenAPIPackage.createPackageContents();

		// Initialize created meta-data
		theXOpenAPIPackage.initializePackageContents();
			...
			(theXOpenAPIPackage, 
			 new EValidator.Descriptor() {
				 public EValidator getEValidator() {
					 return XOpenAPIValidator.INSTANCE;
				 }
			 });

		// Mark meta-data to indicate it can't be changed
		theXOpenAPIPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(XOpenAPIPackage.eNS_URI, theXOpenAPIPackage);
		return theXOpenAPIPackage;
	}
	 ...
	 * @generated
	 */
	public EReference getAPI_Extensions() {
	 ...
	 * @generated
	 */
	public EClass getSchemaExtension() {
		return schemaExtensionEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getEntity_NavigationProperties() {
	 ...
	 * @generated
	 */
	public EAttribute getProperty_Multivalued() {
	 ...
	 * @generated
	 */
	public EAttribute getNavigationProperty_Multivalued() {
		return (EAttribute)navigationPropertyEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getNavigationProperty_Target() {
		return (EReference)navigationPropertyEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public XOpenAPIFactory getXOpenAPIFactory() {
		return (XOpenAPIFactory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		createEReference(apiEClass, API__EXTENSIONS);
		...
		schemaExtensionEClass = createEClass(SCHEMA_EXTENSION);
		...
		createEReference(entityEClass, ENTITY__NAVIGATION_PROPERTIES);

		propertyEClass = createEClass(PROPERTY);
		createEAttribute(propertyEClass, PROPERTY__MULTIVALUED);

		navigationPropertyEClass = createEClass(NAVIGATION_PROPERTY);
		createEAttribute(navigationPropertyEClass, NAVIGATION_PROPERTY__MULTIVALUED);
		createEReference(navigationPropertyEClass, NAVIGATION_PROPERTY__TARGET);
	...
	public void initializePackageContents() {
		...
		schemaExtensionEClass.getESuperTypes().add(this.getNamedElement());
		entityEClass.getESuperTypes().add(this.getSchemaExtension());
		propertyEClass.getESuperTypes().add(this.getSchemaExtension());
		propertyEClass.getESuperTypes().add(this.getTypedElement());
		navigationPropertyEClass.getESuperTypes().add(this.getSchemaExtension());
		...
		initEClass(apiEClass, edu.uoc.som.xopenapi.API.class, "API", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getAPI_Swagger(), ecorePackage.getEString(), "swagger", null, 0, 1, edu.uoc.som.xopenapi.API.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getAPI_Info(), this.getInfo(), null, "info", null, 0, 1, edu.uoc.som.xopenapi.API.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getAPI_Host(), ecorePackage.getEString(), "host", null, 0, 1, edu.uoc.som.xopenapi.API.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getAPI_BasePath(), ecorePackage.getEString(), "basePath", null, 0, 1, edu.uoc.som.xopenapi.API.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getAPI_Schemes(), this.getSchemeType(), "schemes", null, 0, -1, edu.uoc.som.xopenapi.API.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getAPI_Consumes(), ecorePackage.getEString(), "consumes", null, 0, -1, edu.uoc.som.xopenapi.API.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getAPI_Produces(), ecorePackage.getEString(), "produces", null, 0, -1, edu.uoc.som.xopenapi.API.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getAPI_Paths(), this.getPath(), this.getPath_Api(), "paths", null, 0, -1, edu.uoc.som.xopenapi.API.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getAPI_Definitions(), this.getSchema(), null, "definitions", null, 0, -1, edu.uoc.som.xopenapi.API.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getAPI_Responses(), this.getResponse(), null, "responses", null, 0, -1, edu.uoc.som.xopenapi.API.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getAPI_SecurityDefinitions(), this.getSecuritySchema(), null, "securityDefinitions", null, 0, -1, edu.uoc.som.xopenapi.API.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getAPI_Tags(), this.getTag(), null, "tags", null, 0, -1, edu.uoc.som.xopenapi.API.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getAPI_Extensions(), this.getSchemaExtension(), null, "extensions", null, 0, -1, edu.uoc.som.xopenapi.API.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEClass(schemaExtensionEClass, SchemaExtension.class, "SchemaExtension", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		...
		initEReference(getEntity_NavigationProperties(), this.getNavigationProperty(), null, "navigationProperties", null, 0, -1, Entity.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(propertyEClass, Property.class, "Property", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getProperty_Multivalued(), ecorePackage.getEBooleanObject(), "multivalued", null, 0, 1, Property.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getNavigationProperty_Multivalued(), ecorePackage.getEBooleanObject(), "multivalued", null, 0, 1, NavigationProperty.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getNavigationProperty_Target(), this.getEntity(), null, "target", null, 0, 1, NavigationProperty.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
