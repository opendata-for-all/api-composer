 ...
 * </p>
 * <ul>
 *   <li>{@link edu.uoc.som.xopenapi.impl.JSONPointerImpl#getRef <em>Ref</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class JSONPointerImpl extends MinimalEObjectImpl.Container implements JSONPointer {
	...
	protected EClass eStaticClass() {
		return XOpenAPIPackage.Literals.JSON_POINTER;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case XOpenAPIPackage.JSON_POINTER__REF:
				return getRef();
		}
