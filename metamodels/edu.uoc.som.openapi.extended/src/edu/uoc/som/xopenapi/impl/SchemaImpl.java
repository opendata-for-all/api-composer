 ...
 * </p>
 * <ul>
 *   <li>{@link edu.uoc.som.xopenapi.impl.SchemaImpl#getRef <em>Ref</em>}</li>
 *   <li>{@link edu.uoc.som.xopenapi.impl.SchemaImpl#getExternalDocs <em>External Docs</em>}</li>
 *   <li>{@link edu.uoc.som.xopenapi.impl.SchemaImpl#getName <em>Name</em>}</li>
 *   <li>{@link edu.uoc.som.xopenapi.impl.SchemaImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link edu.uoc.som.xopenapi.impl.SchemaImpl#getMaxProperties <em>Max Properties</em>}</li>
 *   <li>{@link edu.uoc.som.xopenapi.impl.SchemaImpl#getMinProperties <em>Min Properties</em>}</li>
 *   <li>{@link edu.uoc.som.xopenapi.impl.SchemaImpl#getExample <em>Example</em>}</li>
 *   <li>{@link edu.uoc.som.xopenapi.impl.SchemaImpl#getDiscriminator <em>Discriminator</em>}</li>
 *   <li>{@link edu.uoc.som.xopenapi.impl.SchemaImpl#getReadOnly <em>Read Only</em>}</li>
 *   <li>{@link edu.uoc.som.xopenapi.impl.SchemaImpl#getProperties <em>Properties</em>}</li>
 *   <li>{@link edu.uoc.som.xopenapi.impl.SchemaImpl#getAllOf <em>All Of</em>}</li>
 *   <li>{@link edu.uoc.som.xopenapi.impl.SchemaImpl#getItems <em>Items</em>}</li>
 *   <li>{@link edu.uoc.som.xopenapi.impl.SchemaImpl#getXml <em>Xml</em>}</li>
 *   <li>{@link edu.uoc.som.xopenapi.impl.SchemaImpl#getAdditonalProperties <em>Additonal Properties</em>}</li>
 *   <li>{@link edu.uoc.som.xopenapi.impl.SchemaImpl#getDeclaringContext <em>Declaring Context</em>}</li>
 *   <li>{@link edu.uoc.som.xopenapi.impl.SchemaImpl#getRequired <em>Required</em>}</li>
 *   <li>{@link edu.uoc.som.xopenapi.impl.SchemaImpl#getValue <em>Value</em>}</li>
 *   <li>{@link edu.uoc.som.xopenapi.impl.SchemaImpl#isAdditonalPropertiesAllowed <em>Additonal Properties Allowed</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SchemaImpl extends JSONSchemaSubsetImpl implements Schema {
	...
	protected EClass eStaticClass() {
		return XOpenAPIPackage.Literals.SCHEMA;
	}
	...
	public String getRef() {
		if (getDeclaringContext() instanceof API) {
			return ((API) getDeclaringContext()).getRef() + "/definitions/" + getName();
	...
	public NotificationChain basicSetExternalDocs(ExternalDocs newExternalDocs, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, XOpenAPIPackage.SCHEMA__EXTERNAL_DOCS, oldExternalDocs, newExternalDocs);
	...
	public void setExternalDocs(ExternalDocs newExternalDocs) {
		if (newExternalDocs != externalDocs) {
			...
			if (externalDocs != null)
				msgs = ((InternalEObject)externalDocs).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - XOpenAPIPackage.SCHEMA__EXTERNAL_DOCS, null, msgs);
			if (newExternalDocs != null)
				msgs = ((InternalEObject)newExternalDocs).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - XOpenAPIPackage.SCHEMA__EXTERNAL_DOCS, null, msgs);
			msgs = basicSetExternalDocs(newExternalDocs, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XOpenAPIPackage.SCHEMA__EXTERNAL_DOCS, newExternalDocs, newExternalDocs));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XOpenAPIPackage.SCHEMA__NAME, oldName, name));
	}
	...
	public void setTitle(String newTitle) {
		...
		title = newTitle;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XOpenAPIPackage.SCHEMA__TITLE, oldTitle, title));
	}
	...
	public void setMaxProperties(Integer newMaxProperties) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XOpenAPIPackage.SCHEMA__MAX_PROPERTIES, oldMaxProperties, maxProperties));
	}
	...
	public void setMinProperties(Integer newMinProperties) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XOpenAPIPackage.SCHEMA__MIN_PROPERTIES, oldMinProperties, minProperties));
	}
	...
	public void setExample(String newExample) {
		...
		example = newExample;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XOpenAPIPackage.SCHEMA__EXAMPLE, oldExample, example));
	}
	...
	public void setDiscriminator(String newDiscriminator) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XOpenAPIPackage.SCHEMA__DISCRIMINATOR, oldDiscriminator, discriminator));
	}
	...
	public void setReadOnly(Boolean newReadOnly) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XOpenAPIPackage.SCHEMA__READ_ONLY, oldReadOnly, readOnly));
	}
	...
	public EList<Schema> getProperties() {
		if (properties == null) {
			properties = new EObjectResolvingEList<Schema>(Schema.class, this, XOpenAPIPackage.SCHEMA__PROPERTIES);
		}
		return properties;
	}
	...
	public EList<Schema> getAllOf() {
		if (allOf == null) {
			allOf = new EObjectResolvingEList<Schema>(Schema.class, this, XOpenAPIPackage.SCHEMA__ALL_OF);
		}
		return allOf;
	}
	...
	public Schema getItems() {
		if (items != null && items.eIsProxy()) {
			...
			if (items != oldItems) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, XOpenAPIPackage.SCHEMA__ITEMS, oldItems, items));
			}
		}
		return items;
	}
	...
	public void setItems(Schema newItems) {
		...
		items = newItems;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XOpenAPIPackage.SCHEMA__ITEMS, oldItems, items));
	}
	...
	public NotificationChain basicSetXml(XMLElement newXml, NotificationChain msgs) {
		...
		xml = newXml;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, XOpenAPIPackage.SCHEMA__XML, oldXml, newXml);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setXml(XMLElement newXml) {
		if (newXml != xml) {
			NotificationChain msgs = null;
			if (xml != null)
				msgs = ((InternalEObject)xml).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - XOpenAPIPackage.SCHEMA__XML, null, msgs);
			if (newXml != null)
				msgs = ((InternalEObject)newXml).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - XOpenAPIPackage.SCHEMA__XML, null, msgs);
			msgs = basicSetXml(newXml, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XOpenAPIPackage.SCHEMA__XML, newXml, newXml));
	}
	...
	public Schema getAdditonalProperties() {
		if (additonalProperties != null && additonalProperties.eIsProxy()) {
			...
			if (additonalProperties != oldAdditonalProperties) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, XOpenAPIPackage.SCHEMA__ADDITONAL_PROPERTIES, oldAdditonalProperties, additonalProperties));
			}
		}
	...
	public void setAdditonalProperties(Schema newAdditonalProperties) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XOpenAPIPackage.SCHEMA__ADDITONAL_PROPERTIES, oldAdditonalProperties, additonalProperties));
	}
	...
	public SchemaDeclaringContext getDeclaringContext() {
		if (declaringContext != null && declaringContext.eIsProxy()) {
			...
			if (declaringContext != oldDeclaringContext) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, XOpenAPIPackage.SCHEMA__DECLARING_CONTEXT, oldDeclaringContext, declaringContext));
			}
		}
	...
	public void setDeclaringContext(SchemaDeclaringContext newDeclaringContext) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XOpenAPIPackage.SCHEMA__DECLARING_CONTEXT, oldDeclaringContext, declaringContext));
	}
	...
	public EList<Schema> getRequired() {
		if (required == null) {
			required = new EObjectResolvingEList<Schema>(Schema.class, this, XOpenAPIPackage.SCHEMA__REQUIRED);
		}
		return required;
	}
	...
	public Schema getValue() {
		if (value != null && value.eIsProxy()) {
			...
			if (value != oldValue) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, XOpenAPIPackage.SCHEMA__VALUE, oldValue, value));
			}
		}
		return value;
	}
	...
	public void setValue(Schema newValue) {
		...
		value = newValue;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XOpenAPIPackage.SCHEMA__VALUE, oldValue, value));
	}
	...
	public void setAdditonalPropertiesAllowed(boolean newAdditonalPropertiesAllowed) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XOpenAPIPackage.SCHEMA__ADDITONAL_PROPERTIES_ALLOWED, oldAdditonalPropertiesAllowed, additonalPropertiesAllowed));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case XOpenAPIPackage.SCHEMA__EXTERNAL_DOCS:
				return basicSetExternalDocs(null, msgs);
			case XOpenAPIPackage.SCHEMA__XML:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case XOpenAPIPackage.SCHEMA__REF:
				return getRef();
			case XOpenAPIPackage.SCHEMA__EXTERNAL_DOCS:
				return getExternalDocs();
			case XOpenAPIPackage.SCHEMA__NAME:
				return getName();
			case XOpenAPIPackage.SCHEMA__TITLE:
				return getTitle();
			case XOpenAPIPackage.SCHEMA__MAX_PROPERTIES:
				return getMaxProperties();
			case XOpenAPIPackage.SCHEMA__MIN_PROPERTIES:
				return getMinProperties();
			case XOpenAPIPackage.SCHEMA__EXAMPLE:
				return getExample();
			case XOpenAPIPackage.SCHEMA__DISCRIMINATOR:
				return getDiscriminator();
			case XOpenAPIPackage.SCHEMA__READ_ONLY:
				return getReadOnly();
			case XOpenAPIPackage.SCHEMA__PROPERTIES:
				return getProperties();
			case XOpenAPIPackage.SCHEMA__ALL_OF:
				return getAllOf();
			case XOpenAPIPackage.SCHEMA__ITEMS:
				if (resolve) return getItems();
				return basicGetItems();
			case XOpenAPIPackage.SCHEMA__XML:
				return getXml();
			case XOpenAPIPackage.SCHEMA__ADDITONAL_PROPERTIES:
				if (resolve) return getAdditonalProperties();
				return basicGetAdditonalProperties();
			case XOpenAPIPackage.SCHEMA__DECLARING_CONTEXT:
				if (resolve) return getDeclaringContext();
				return basicGetDeclaringContext();
			case XOpenAPIPackage.SCHEMA__REQUIRED:
				return getRequired();
			case XOpenAPIPackage.SCHEMA__VALUE:
				if (resolve) return getValue();
				return basicGetValue();
			case XOpenAPIPackage.SCHEMA__ADDITONAL_PROPERTIES_ALLOWED:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		...
		if (baseClass == JSONPointer.class) {
			switch (derivedFeatureID) {
				case XOpenAPIPackage.SCHEMA__REF: return XOpenAPIPackage.JSON_POINTER__REF;
				default: return -1;
			}
		}
		if (baseClass == ExternalDocsContext.class) {
			switch (derivedFeatureID) {
				case XOpenAPIPackage.SCHEMA__EXTERNAL_DOCS: return XOpenAPIPackage.EXTERNAL_DOCS_CONTEXT__EXTERNAL_DOCS;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		...
		if (baseClass == JSONPointer.class) {
			switch (baseFeatureID) {
				case XOpenAPIPackage.JSON_POINTER__REF: return XOpenAPIPackage.SCHEMA__REF;
				default: return -1;
			}
		}
		if (baseClass == ExternalDocsContext.class) {
			switch (baseFeatureID) {
				case XOpenAPIPackage.EXTERNAL_DOCS_CONTEXT__EXTERNAL_DOCS: return XOpenAPIPackage.SCHEMA__EXTERNAL_DOCS;
				default: return -1;
			}
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case XOpenAPIPackage.SCHEMA___GET_PROPERTY_BY_NAME__STRING:
