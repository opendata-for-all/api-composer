 ...
 * </p>
 * <ul>
 *   <li>{@link edu.uoc.som.xopenapi.impl.ItemsDefinitionImpl#getCollectionFormat <em>Collection Format</em>}</li>
 *   <li>{@link edu.uoc.som.xopenapi.impl.ItemsDefinitionImpl#getItems <em>Items</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ItemsDefinitionImpl extends JSONSchemaSubsetImpl implements ItemsDefinition {
	...
	protected EClass eStaticClass() {
		return XOpenAPIPackage.Literals.ITEMS_DEFINITION;
	}
	...
	public void setCollectionFormat(CollectionFormat newCollectionFormat) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XOpenAPIPackage.ITEMS_DEFINITION__COLLECTION_FORMAT, oldCollectionFormat, collectionFormat));
	}
	...
	public NotificationChain basicSetItems(ItemsDefinition newItems, NotificationChain msgs) {
		...
		items = newItems;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, XOpenAPIPackage.ITEMS_DEFINITION__ITEMS, oldItems, newItems);
	...
	public void setItems(ItemsDefinition newItems) {
		if (newItems != items) {
			...
			if (items != null)
				msgs = ((InternalEObject)items).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - XOpenAPIPackage.ITEMS_DEFINITION__ITEMS, null, msgs);
			if (newItems != null)
				msgs = ((InternalEObject)newItems).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - XOpenAPIPackage.ITEMS_DEFINITION__ITEMS, null, msgs);
			msgs = basicSetItems(newItems, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XOpenAPIPackage.ITEMS_DEFINITION__ITEMS, newItems, newItems));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case XOpenAPIPackage.ITEMS_DEFINITION__ITEMS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case XOpenAPIPackage.ITEMS_DEFINITION__COLLECTION_FORMAT:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == ArrayContext.class) {
			switch (derivedFeatureID) {
				case XOpenAPIPackage.ITEMS_DEFINITION__COLLECTION_FORMAT: return XOpenAPIPackage.ARRAY_CONTEXT__COLLECTION_FORMAT;
				case XOpenAPIPackage.ITEMS_DEFINITION__ITEMS: return XOpenAPIPackage.ARRAY_CONTEXT__ITEMS;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == ArrayContext.class) {
			switch (baseFeatureID) {
				case XOpenAPIPackage.ARRAY_CONTEXT__COLLECTION_FORMAT: return XOpenAPIPackage.ITEMS_DEFINITION__COLLECTION_FORMAT;
				case XOpenAPIPackage.ARRAY_CONTEXT__ITEMS: return XOpenAPIPackage.ITEMS_DEFINITION__ITEMS;
				default: return -1;
			}
		}
