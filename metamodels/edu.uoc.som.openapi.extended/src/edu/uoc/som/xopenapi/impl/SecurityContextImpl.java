 ...
 * </p>
 * <ul>
 *   <li>{@link edu.uoc.som.xopenapi.impl.SecurityContextImpl#getSecurityRequirements <em>Security Requirements</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class SecurityContextImpl extends MinimalEObjectImpl.Container implements SecurityContext {
	...
	protected EClass eStaticClass() {
		return XOpenAPIPackage.Literals.SECURITY_CONTEXT;
	}
	...
	public EList<SecurityRequirement> getSecurityRequirements() {
		if (securityRequirements == null) {
			securityRequirements = new EObjectContainmentEList<SecurityRequirement>(SecurityRequirement.class, this, XOpenAPIPackage.SECURITY_CONTEXT__SECURITY_REQUIREMENTS);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case XOpenAPIPackage.SECURITY_CONTEXT__SECURITY_REQUIREMENTS:
