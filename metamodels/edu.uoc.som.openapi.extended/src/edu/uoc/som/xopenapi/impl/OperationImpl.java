 ...
 * </p>
 * <ul>
 *   <li>{@link edu.uoc.som.xopenapi.impl.OperationImpl#getSecurityRequirements <em>Security Requirements</em>}</li>
 *   <li>{@link edu.uoc.som.xopenapi.impl.OperationImpl#getParameters <em>Parameters</em>}</li>
 *   <li>{@link edu.uoc.som.xopenapi.impl.OperationImpl#getExternalDocs <em>External Docs</em>}</li>
 *   <li>{@link edu.uoc.som.xopenapi.impl.OperationImpl#getTagReferences <em>Tag References</em>}</li>
 *   <li>{@link edu.uoc.som.xopenapi.impl.OperationImpl#getSummary <em>Summary</em>}</li>
 *   <li>{@link edu.uoc.som.xopenapi.impl.OperationImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link edu.uoc.som.xopenapi.impl.OperationImpl#getOperationId <em>Operation Id</em>}</li>
 *   <li>{@link edu.uoc.som.xopenapi.impl.OperationImpl#getConsumes <em>Consumes</em>}</li>
 *   <li>{@link edu.uoc.som.xopenapi.impl.OperationImpl#getProduces <em>Produces</em>}</li>
 *   <li>{@link edu.uoc.som.xopenapi.impl.OperationImpl#getResponses <em>Responses</em>}</li>
 *   <li>{@link edu.uoc.som.xopenapi.impl.OperationImpl#getSchemes <em>Schemes</em>}</li>
 *   <li>{@link edu.uoc.som.xopenapi.impl.OperationImpl#getDeprecated <em>Deprecated</em>}</li>
 * </ul>
 *
 * @generated
 */
public class OperationImpl extends ParamterDeclaringContextImpl implements Operation {
	...
	protected EClass eStaticClass() {
		return XOpenAPIPackage.Literals.OPERATION;
	}
	...
	public EList<SecurityRequirement> getSecurityRequirements() {
		if (securityRequirements == null) {
			securityRequirements = new EObjectContainmentEList<SecurityRequirement>(SecurityRequirement.class, this, XOpenAPIPackage.OPERATION__SECURITY_REQUIREMENTS);
		}
	...
	public EList<Parameter> getParameters() {
		if (parameters == null) {
			parameters = new EObjectResolvingEList<Parameter>(Parameter.class, this, XOpenAPIPackage.OPERATION__PARAMETERS);
		}
		return parameters;
	}
	...
	public NotificationChain basicSetExternalDocs(ExternalDocs newExternalDocs, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, XOpenAPIPackage.OPERATION__EXTERNAL_DOCS, oldExternalDocs, newExternalDocs);
	...
	public void setExternalDocs(ExternalDocs newExternalDocs) {
		if (newExternalDocs != externalDocs) {
			...
			if (externalDocs != null)
				msgs = ((InternalEObject)externalDocs).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - XOpenAPIPackage.OPERATION__EXTERNAL_DOCS, null, msgs);
			if (newExternalDocs != null)
				msgs = ((InternalEObject)newExternalDocs).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - XOpenAPIPackage.OPERATION__EXTERNAL_DOCS, null, msgs);
			msgs = basicSetExternalDocs(newExternalDocs, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XOpenAPIPackage.OPERATION__EXTERNAL_DOCS, newExternalDocs, newExternalDocs));
	}
	...
	public EList<String> getTagReferences() {
		if (tagReferences == null) {
			tagReferences = new EDataTypeUniqueEList<String>(String.class, this, XOpenAPIPackage.OPERATION__TAG_REFERENCES);
		}
	...
	public void setSummary(String newSummary) {
		...
		summary = newSummary;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XOpenAPIPackage.OPERATION__SUMMARY, oldSummary, summary));
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XOpenAPIPackage.OPERATION__DESCRIPTION, oldDescription, description));
	}
	...
	public void setOperationId(String newOperationId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XOpenAPIPackage.OPERATION__OPERATION_ID, oldOperationId, operationId));
	}
	...
	public EList<String> getConsumes() {
		if (consumes == null) {
			consumes = new EDataTypeUniqueEList<String>(String.class, this, XOpenAPIPackage.OPERATION__CONSUMES);
		}
		return consumes;
	}
	...
	public EList<String> getProduces() {
		if (produces == null) {
			produces = new EDataTypeUniqueEList<String>(String.class, this, XOpenAPIPackage.OPERATION__PRODUCES);
		}
		return produces;
	}
	...
	public EList<Response> getResponses() {
		if (responses == null) {
			responses = new EObjectResolvingEList<Response>(Response.class, this, XOpenAPIPackage.OPERATION__RESPONSES);
		}
		return responses;
	}
	...
	public EList<SchemeType> getSchemes() {
		if (schemes == null) {
			schemes = new EDataTypeUniqueEList<SchemeType>(SchemeType.class, this, XOpenAPIPackage.OPERATION__SCHEMES);
		}
		return schemes;
	}
	...
	public void setDeprecated(Boolean newDeprecated) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XOpenAPIPackage.OPERATION__DEPRECATED, oldDeprecated, deprecated));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case XOpenAPIPackage.OPERATION__SECURITY_REQUIREMENTS:
				return ((InternalEList<?>)getSecurityRequirements()).basicRemove(otherEnd, msgs);
			case XOpenAPIPackage.OPERATION__EXTERNAL_DOCS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case XOpenAPIPackage.OPERATION__PARAMETERS:
				return getParameters();
			case XOpenAPIPackage.OPERATION__EXTERNAL_DOCS:
				return getExternalDocs();
			case XOpenAPIPackage.OPERATION__TAG_REFERENCES:
				return getTagReferences();
			case XOpenAPIPackage.OPERATION__SUMMARY:
				return getSummary();
			case XOpenAPIPackage.OPERATION__DESCRIPTION:
				return getDescription();
			case XOpenAPIPackage.OPERATION__OPERATION_ID:
				return getOperationId();
			case XOpenAPIPackage.OPERATION__CONSUMES:
				return getConsumes();
			case XOpenAPIPackage.OPERATION__PRODUCES:
				return getProduces();
			case XOpenAPIPackage.OPERATION__RESPONSES:
				return getResponses();
			case XOpenAPIPackage.OPERATION__SCHEMES:
				return getSchemes();
			case XOpenAPIPackage.OPERATION__DEPRECATED:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == SecurityContext.class) {
			switch (derivedFeatureID) {
				case XOpenAPIPackage.OPERATION__SECURITY_REQUIREMENTS: return XOpenAPIPackage.SECURITY_CONTEXT__SECURITY_REQUIREMENTS;
				default: return -1;
			}
		}
		if (baseClass == ParameterContext.class) {
			switch (derivedFeatureID) {
				case XOpenAPIPackage.OPERATION__PARAMETERS: return XOpenAPIPackage.PARAMETER_CONTEXT__PARAMETERS;
				default: return -1;
			}
		}
		if (baseClass == ExternalDocsContext.class) {
			switch (derivedFeatureID) {
				case XOpenAPIPackage.OPERATION__EXTERNAL_DOCS: return XOpenAPIPackage.EXTERNAL_DOCS_CONTEXT__EXTERNAL_DOCS;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == SecurityContext.class) {
			switch (baseFeatureID) {
				case XOpenAPIPackage.SECURITY_CONTEXT__SECURITY_REQUIREMENTS: return XOpenAPIPackage.OPERATION__SECURITY_REQUIREMENTS;
				default: return -1;
			}
		}
		if (baseClass == ParameterContext.class) {
			switch (baseFeatureID) {
				case XOpenAPIPackage.PARAMETER_CONTEXT__PARAMETERS: return XOpenAPIPackage.OPERATION__PARAMETERS;
				default: return -1;
			}
		}
		if (baseClass == ExternalDocsContext.class) {
			switch (baseFeatureID) {
				case XOpenAPIPackage.EXTERNAL_DOCS_CONTEXT__EXTERNAL_DOCS: return XOpenAPIPackage.OPERATION__EXTERNAL_DOCS;
				default: return -1;
			}
		}
		if (baseClass == ResponseDeclaringContext.class) {
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case XOpenAPIPackage.OPERATION___GET_FULL_PATH:
				return getFullPath();
			case XOpenAPIPackage.OPERATION___GET_CONSUMED_SCHEMA:
				return getConsumedSchema();
			case XOpenAPIPackage.OPERATION___GET_PRODUCED_SCHEMA:
				return getProducedSchema();
			case XOpenAPIPackage.OPERATION___IS_PRODUCING_LIST:
				return IsProducingList();
			case XOpenAPIPackage.OPERATION___GET_METHOD:
				return getMethod();
		}
