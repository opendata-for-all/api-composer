 ...
 * </p>
 * <ul>
 *   <li>{@link edu.uoc.som.xopenapi.impl.ParameterContextImpl#getParameters <em>Parameters</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class ParameterContextImpl extends MinimalEObjectImpl.Container implements ParameterContext {
	...
	protected EClass eStaticClass() {
		return XOpenAPIPackage.Literals.PARAMETER_CONTEXT;
	}
	...
	public EList<Parameter> getParameters() {
		if (parameters == null) {
			parameters = new EObjectResolvingEList<Parameter>(Parameter.class, this, XOpenAPIPackage.PARAMETER_CONTEXT__PARAMETERS);
		}
		return parameters;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case XOpenAPIPackage.PARAMETER_CONTEXT__PARAMETERS:
