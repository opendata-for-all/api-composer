 ...
 * </p>
 * <ul>
 *   <li>{@link edu.uoc.som.xopenapi.impl.SecurityRequirementImpl#getSecurityScopes <em>Security Scopes</em>}</li>
 *   <li>{@link edu.uoc.som.xopenapi.impl.SecurityRequirementImpl#getSecuritySchema <em>Security Schema</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SecurityRequirementImpl extends MinimalEObjectImpl.Container implements SecurityRequirement {
	...
	protected EClass eStaticClass() {
		return XOpenAPIPackage.Literals.SECURITY_REQUIREMENT;
	}
	...
	public EList<SecurityScope> getSecurityScopes() {
		if (securityScopes == null) {
			securityScopes = new EObjectResolvingEList<SecurityScope>(SecurityScope.class, this, XOpenAPIPackage.SECURITY_REQUIREMENT__SECURITY_SCOPES);
		}
		...
		if (securitySchema != null && securitySchema.eIsProxy()) {
			...
			if (securitySchema != oldSecuritySchema) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, XOpenAPIPackage.SECURITY_REQUIREMENT__SECURITY_SCHEMA, oldSecuritySchema, securitySchema));
			}
		}
	...
	public void setSecuritySchema(SecuritySchema newSecuritySchema) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XOpenAPIPackage.SECURITY_REQUIREMENT__SECURITY_SCHEMA, oldSecuritySchema, securitySchema));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case XOpenAPIPackage.SECURITY_REQUIREMENT__SECURITY_SCOPES:
				return getSecurityScopes();
			case XOpenAPIPackage.SECURITY_REQUIREMENT__SECURITY_SCHEMA:
