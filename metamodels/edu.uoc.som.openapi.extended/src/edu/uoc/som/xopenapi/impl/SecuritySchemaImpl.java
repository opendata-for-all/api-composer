 ...
 * </p>
 * <ul>
 *   <li>{@link edu.uoc.som.xopenapi.impl.SecuritySchemaImpl#getType <em>Type</em>}</li>
 *   <li>{@link edu.uoc.som.xopenapi.impl.SecuritySchemaImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link edu.uoc.som.xopenapi.impl.SecuritySchemaImpl#getName <em>Name</em>}</li>
 *   <li>{@link edu.uoc.som.xopenapi.impl.SecuritySchemaImpl#getLocation <em>Location</em>}</li>
 *   <li>{@link edu.uoc.som.xopenapi.impl.SecuritySchemaImpl#getFlow <em>Flow</em>}</li>
 *   <li>{@link edu.uoc.som.xopenapi.impl.SecuritySchemaImpl#getAuthorizationUrl <em>Authorization Url</em>}</li>
 *   <li>{@link edu.uoc.som.xopenapi.impl.SecuritySchemaImpl#getTokenUrl <em>Token Url</em>}</li>
 *   <li>{@link edu.uoc.som.xopenapi.impl.SecuritySchemaImpl#getReferenceName <em>Reference Name</em>}</li>
 *   <li>{@link edu.uoc.som.xopenapi.impl.SecuritySchemaImpl#getScopes <em>Scopes</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SecuritySchemaImpl extends MinimalEObjectImpl.Container implements SecuritySchema {
	...
	protected EClass eStaticClass() {
		return XOpenAPIPackage.Literals.SECURITY_SCHEMA;
	}
	...
	public void setType(SecuritySchemeType newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XOpenAPIPackage.SECURITY_SCHEMA__TYPE, oldType, type));
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XOpenAPIPackage.SECURITY_SCHEMA__DESCRIPTION, oldDescription, description));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XOpenAPIPackage.SECURITY_SCHEMA__NAME, oldName, name));
	}
	...
	public void setLocation(APIKeyLocation newLocation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XOpenAPIPackage.SECURITY_SCHEMA__LOCATION, oldLocation, location));
	}
	...
	public void setFlow(OAuth2FlowType newFlow) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XOpenAPIPackage.SECURITY_SCHEMA__FLOW, oldFlow, flow));
	}
	...
	public void setAuthorizationUrl(String newAuthorizationUrl) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XOpenAPIPackage.SECURITY_SCHEMA__AUTHORIZATION_URL, oldAuthorizationUrl, authorizationUrl));
	}
	...
	public void setTokenUrl(String newTokenUrl) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XOpenAPIPackage.SECURITY_SCHEMA__TOKEN_URL, oldTokenUrl, tokenUrl));
	}
	...
	public void setReferenceName(String newReferenceName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XOpenAPIPackage.SECURITY_SCHEMA__REFERENCE_NAME, oldReferenceName, referenceName));
	}
	...
	public EList<SecurityScope> getScopes() {
		if (scopes == null) {
			scopes = new EObjectContainmentEList<SecurityScope>(SecurityScope.class, this, XOpenAPIPackage.SECURITY_SCHEMA__SCOPES);
		}
		return scopes;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case XOpenAPIPackage.SECURITY_SCHEMA__SCOPES:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case XOpenAPIPackage.SECURITY_SCHEMA__TYPE:
				return getType();
			case XOpenAPIPackage.SECURITY_SCHEMA__DESCRIPTION:
				return getDescription();
			case XOpenAPIPackage.SECURITY_SCHEMA__NAME:
				return getName();
			case XOpenAPIPackage.SECURITY_SCHEMA__LOCATION:
				return getLocation();
			case XOpenAPIPackage.SECURITY_SCHEMA__FLOW:
				return getFlow();
			case XOpenAPIPackage.SECURITY_SCHEMA__AUTHORIZATION_URL:
				return getAuthorizationUrl();
			case XOpenAPIPackage.SECURITY_SCHEMA__TOKEN_URL:
				return getTokenUrl();
			case XOpenAPIPackage.SECURITY_SCHEMA__REFERENCE_NAME:
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case XOpenAPIPackage.SECURITY_SCHEMA___GET_SECURITY_SCOPE_BY_NAME__STRING:
