 ...
 * @generated
 */
public class BindSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case BindPackage.BINDING_MODEL: {
				BindingModel bindingModel = (BindingModel)theEObject;
				T result = caseBindingModel(bindingModel);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case BindPackage.BINDING_ELEMENT: {
				BindingElement bindingElement = (BindingElement)theEObject;
				T result = caseBindingElement(bindingElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case BindPackage.ENTITY_BINDING: {
				EntityBinding entityBinding = (EntityBinding)theEObject;
				T result = caseEntityBinding(entityBinding);
				if (result == null) result = caseBindingElement(entityBinding);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case BindPackage.PROPERTY_BINDING: {
				PropertyBinding propertyBinding = (PropertyBinding)theEObject;
				T result = casePropertyBinding(propertyBinding);
				if (result == null) result = caseBindingElement(propertyBinding);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case BindPackage.NAVIGATION_PROPERTY_BINDING: {
				NavigationPropertyBinding navigationPropertyBinding = (NavigationPropertyBinding)theEObject;
				T result = caseNavigationPropertyBinding(navigationPropertyBinding);
				if (result == null) result = caseBindingElement(navigationPropertyBinding);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Navigation Property Binding</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Navigation Property Binding</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseNavigationPropertyBinding(NavigationPropertyBinding object) {
		return null;
	}
